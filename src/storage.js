import { COLUMNS, FIELDS, NUMERIC_FIELDS, computeDerived, toNumber } from './schema.js';
...
export function saveOperations(rows) {
  localStorage.setItem(STORAGE_KEY, JSON.stringify(rows));
}

export function normalizeRecord(values) {
  const record = {};
...
export function importRows(records) {
...
export function exportRows() {
  return loadOperations().map((r) => computeDerived(r));
}
